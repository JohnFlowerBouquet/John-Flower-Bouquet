...
function fadeAway() {
    ...
    var height = - window.pageYOffset * 0.1;
...
function projectsHeading() {
    ...
    var projects = document.querySelector('#projectsHeading');
    if (window.scrollY > (main.offsetTop - window.innerHeight)) {
        projects.classList.add("static");
    } else {
        projects.classList.remove("static");
    }
}
window.addEventListener('scroll', projectsHeading);